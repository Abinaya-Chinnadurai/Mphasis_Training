 ...
 function getPrice1() {
		...
		var restaurantArray = new Array("Coal Barbecues","Basil With A Twist"," Sunset Grill",
"Haunted"," The RainForest"," The Waterfall Restaurant", "Al Arab", "Dindigul Biryani");
var bg_image = new Array("url('coal.jpg')","url('basil.jpg')","url('sunset.jpg')","url('haunted.jpg')","url('rain.jpg')",
"url('fall.jpg')", "url('madras.jpg')", "url('dindi.jpg')");
		var tb_color = new Array("pink","b3ecff","b3ffb3","e6b3cc","ffbb99","00b3b3","#ccccff", "#ff1a75");
        var i = 0;
